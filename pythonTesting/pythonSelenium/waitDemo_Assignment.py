...
# Exercise: "Total After Discount" should be less than the "Total Amount"
totalAfterDiscount = float(driver.find_element(By.CSS_SELECTOR, ".discountAmt").text)   # float()  --> decimal no.
